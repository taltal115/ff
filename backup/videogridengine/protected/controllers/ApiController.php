...
class ApiController extends Controller {
    ...
    public function actionList() {
        ...
        switch ($_GET['model']) {
            case 'foundbox':
                $models = FfFoundbox::model()->with('wpUsers')->findAll();
                break;
             case 'founboxvideo':
                $models = FfFoundboxVideo::model()->findAll();
                break;
            default:
    ...
    public function actionView() {
        ...
        switch ($_GET['model']) {
            ...
            case 'foundbox':
                $model = FfFoundbox::model()->findByPk($_GET['id']);
               // print_r($model);
                break;
             case 'founboxvideo':
                $model = FfFoundboxVideo::model()->findByPk($_GET['id']);
                break;
           // case 'posts':
    ...
    public function actionCreate() {
        switch ($_GET['model']) {
            ...
            case 'foundbox':
                $model = new FfFoundbox();
                break;
             case 'founboxvideo':
                $model = new FfFoundboxVideo();
                break;
            //case 'posts':
             //   $model = new Post;
             //   break;
    ...
    public function actionUpdate() {
        ...
        switch ($_GET['model']) {
            // Find respective model
             case 'foundbox':
                $models = FfFoundbox::model()->findByPk($_GET['id']);
                break;
             case 'founboxvideo':
                $models = FfFoundboxVideo::model()->findByPk($_GET['id']);
                break;
            //case 'posts':
            //    $model = Post::model()->findByPk($_GET['id']);
            //    break;
