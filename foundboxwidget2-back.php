...
<script type="text/javascript">
  ...
  function goTofboxvideos(fboxid){
         
         window.top.location.href="http://findingfootage.com/ffrc/findingfootage/videogridengine/index.php/foundboxesvideos/index/"+fboxid;
     }

                function mIn(videoURL){
               
            var x =500;//window.XPOS;
...
<!--<li>
 ...
 <li>
   ...
   <img src="<?php echo $vid_thumb_url ?>"  onClick='goTofboxvideos("<?php echo $foundboxId; ?>");' onmouseover='mIn("<?php echo $vid_flv_path ?>")' onmouseout="mOut()" class="mini" width="50" height="50" alt="" />
