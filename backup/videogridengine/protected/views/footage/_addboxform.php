...
//    else{
    ...
    $form = $this->beginWidget('GxActiveForm', array(
        'id' => 'foundbox-form',
        'action' => CHtml::normalizeUrl(Yii::app()->createUrl('footage/addboxform')),
            ));
...
//}
?>&nbsp&nbsp
<?php echo GxHtml::ajaxSubmitButton('Save',CHtml::normalizeUrl(Yii::app()->createUrl('search/foundbox')),array(
    'type'=>'POST',
